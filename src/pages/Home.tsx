...
import { ArrowRight, ChevronLeft, ChevronRight, CreditCard, Shield, Truck } from "lucide-react";
      ...
      <section className="py-16 md:py-20 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          <div className="text-center mb-16 md:mb-20">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold dark:text-white mb-3 md:mb-4">
          ...
          <div className="space-y-16 md:space-y-24 lg:space-y-32">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-16 max-w-5xl mx-auto">
              <div className="w-full md:w-2/5">
                <div className="relative overflow-hidden rounded-2xl shadow-lg group max-w-xs sm:max-w-sm mx-auto">
                  <img
              ...
              <div className="w-full md:w-3/5 text-center md:text-left">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 md:mb-4 dark:text-white">
                ...
                <ul className="space-y-2 text-left inline-block mx-auto md:mx-0">
                  <li className="flex items-center gap-2 text-gray-600 dark:text-gray-400 text-sm sm:text-base">
            ...
            {/* Feature 2 */}
            <div className="flex flex-col md:flex-row-reverse items-center gap-8 md:gap-12 lg:gap-16 max-w-5xl mx-auto">
              <div className="w-full md:w-2/5">
                <div className="relative overflow-hidden rounded-2xl shadow-lg group max-w-xs sm:max-w-sm mx-auto">
                  <img
